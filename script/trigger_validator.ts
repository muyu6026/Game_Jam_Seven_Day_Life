module validator {
	//$$spark_core.ai.testai.default_units_ts_AIBehavior:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_240644303:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let 正在施法: boolean = AI.is_casting(AI.unit);
		AI.unit.clean_recast();
		return 正在施法;
	}

	//$$spark_core.ai.testai.default_units_ts_AIBehavior_1:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_104986873:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		if ((AI.unit.has_restriction_custom(单位状态["失控"]))) {
			return true;
		} else {
			return false;
		}
	...
	//$$spark_core.ai.testai.default_units_ts_AIBehavior_10:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_243164383:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
	...
	//$$spark_core.ai.testai.default_units_ts_AIBehavior_11:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_75033395:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 目标: Unit | undefined = AI.params.get("__ai_target");
		...
		if ((((目标 == undefined) || (目标.is_valid() == false) || (目标.get_scene_name() != AI.unit.get_scene_name())))) {
			return false;
		} else {
		}
		if (((追逐距离 <= 0))) {
	...
	//$$spark_core.ai.testai.default_units_ts_AIBehavior_2:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_39637044:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 初始点: Point | undefined = AI.params.get("__ai_born");
		// 超出最大距离就回初始点
		if ((((AI.params.get("__ai_force_back") != undefined) && (AI.unit.has_module(_OBJ__UnitData_Module["移动"]) == true)))) {
			...
			if (((AI.unit.get_scene_point().get_scene() == 初始点.get_scene()))&&((AI.unit.get_scene_point().distance(初始点) < 50))) {
	...
	//$$spark_core.ai.testai.default_units_ts_AIBehavior_3:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_95389468:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		...
		if (((目标单位 != undefined))) {
			if (((AI.unit.has_module(_OBJ__UnitData_Module["移动"]) == true))) {
				if (((目标单位.is_alive_ex() == true))) {
					...
					if ((((AI.unit.get_scene_point().get_scene() == 目标点.get_scene()) && (AI.unit.get_scene_point().distance(目标点) > (AI.attack_range + 目标单位.cache.AttackableRadius)) && (目标点.is_block() == false) && (要施放的技能 == undefined)))) {
						AI.try_approach(目标单位, AI.attack_range, 0);
						移动指令目标点 = AI.unit.get_walking_target();
						if ((((移动指令目标点 != undefined) && (移动指令目标点.get_scene() == 目标点.get_scene()) && (移动指令目标点.distance(目标点) > AI.attack_range)))) {
							AI.unit.clean_command();
							AI.unit.stop();
							AI.params.set("__ai_battle_walk_target", undefined);
						} else {
	...
	//$$spark_core.ai.testai.default_units_ts_AIBehavior_4:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_9902169:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		...
		if ((((移动目标点 != undefined) && AI.unit.has_module(_OBJ__UnitData_Module["移动"])))) {
			if (((AI.unit.get_scene_point().get_scene() == 移动目标点.get_scene()))&&((AI.unit.get_scene_point().distance(移动目标点) > 50))) {
	...
	//$$spark_core.ai.testai.default_units_ts_AIBehavior_5:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_76233091:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 初始点: Point | undefined = AI.params.get("__ai_born");
		if (((AI.unit.has_module(_OBJ__UnitData_Module["移动"]) && (AI.unit.get_scene_point().get_scene() == 初始点.get_scene()) && (AI.unit.get_scene_point().distance(初始点) > AI.params.get("__ai_max_reset_range"))))) {
	...
	//$$spark_core.ai.testai.default_units_ts_AIBehavior_6:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_42264203:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 初始点: Point | undefined = AI.params.get("__ai_born");
		let 目标: Unit | undefined = AI.params.get("__ai_target");
		let 追逐距离: number = AI.unit.get_ex(单位属性["追逐距离"], UnitPropertySubType["Final"]);
		...
		if ((((目标 != undefined) && 目标.is_valid() && (AI.unit.get_scene_name() == 目标.get_scene_name()) && (AI.unit.get_scene_point().distance(目标.get_scene_point()) > 追逐距离) && (AI.params.get("__attacked_timer") == undefined)))) {
	...
	//$$spark_core.ai.testai.default_units_ts_AIBehavior_7:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_47369300:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 目标: Unit | undefined = AI.params.get("__ai_target");
	...
	//$$spark_core.ai.testai.default_units_ts_AIBehavior_8:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_179222928:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 目标: Unit | undefined = AI.params.get("__ai_target");
		...
		if (((目标 == undefined))) {
			...
			if ((AI.unit.has_module(_OBJ__UnitData_Module["移动"]))) {
				...
				if (((AI.unit.get_scene_point().get_scene() == 原始点.get_scene()))&&((AI.unit.get_scene_point().distance(原始点) > 50))) {
	...
	//$$spark_core.ai.testai.default_units_ts_AIBehavior_9:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_230146962:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 目标: Unit | undefined = AI.params.get("__ai_target");
	...
	//$$spark_core.ai.testai.root:Data.Game.OnAdd
	/** 
	 * @name func
	 * @noSelf */
	export let validator_48711270:(this: void, AI:lib_common_ai.AI)=>void = (this: void, AI:lib_common_ai.AI):void => {
	...
	//$$spark_core.ai.testai.root:Data.Game.OnProvoke
	/** 
	 * @name func
	 * @noSelf */
	...
	//$$spark_core.ai.沿路线前进ai.AIBehavior:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_861644:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		AI.unit.clean_recast();
		if (((AI.is_casting(AI.unit) || AI.unit.has_restriction_custom(单位状态["失控"])))) {
			return true;
		} else {
		}
		return result;
	...
	//$$spark_core.ai.沿路线前进ai.AIBehavior_1:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_122531029:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		...
		let 上一目标点: Point = AI.params.get("last_point");
		let 当前目标点: Point = AI.params.get("target_point");
		let 在回反击点途中: boolean = AI.params.get("back_to_counter_point");
		let 已超过目标: boolean = AI.params.get("beyond_target_point");
		let 角度1: number = 0;
		let 角度2: number = 0;
		let k1: number = 0;
		let b1: number = 0;
		...
		if (((返回反击起点 == true))) {
			AI.unit.clean_command();
			AI.unit.stop();
			if (((AI.unit.get_scene_point().get_scene() == 反击起点.get_scene()))&&((AI.unit.get_scene_point().distance(反击起点) < 50))) {
				AI.params.set("to_counter_point", undefined);
				AI.params.set("counter_point", undefined);
				AI.params.set("only_return", undefined);
				AI.params.set("back_to_counter_point", false);
				return false;
			} else {
				// 判断是否超过当前目标点
				...
				角度1 = ((角度1 + 360) % 360);
				角度2 = ((角度2 + 360) % 360);
				if ((((base.math.abs((角度1 - 角度2)) <= 90) && (在回反击点途中 != true)))) {
					// 已经超过
					AI.params.set("counter_point", undefined);
					AI.params.set("only_return", undefined);
					...
					AI.params.set("back_to_counter_point", false);
					AI.params.set("to_counter_point", false);
					AI.params.set("exceed_target", true);
					return false;
				} else {
				}
				// 判断是否超过反击起点，超过则返回当前位置与路线的最近点
				...
				if ((((base.math.abs((角度1 - 角度2)) <= 90) && (在回反击点途中 != true)))) {
					// 返回当前位置与路线的最近点
					if (((上一目标点.get_x() == 当前目标点.get_x()))) {
						x = 上一目标点.get_x();
						y = AI.unit.get_scene_point().get_y();
					} else {
						if (((上一目标点.get_y() == 当前目标点.get_y()))) {
					...
					AI.params.set("counter_point", base.scene_point(x, y, undefined, AI.unit.get_scene_name()));
				} else {
				}
				AI.params.set("target_unit", undefined);
				AI.params.set("target_point_battle", undefined);
				AI.params.set("next_skill", undefined);
				if ((AI.unit.has_module(_OBJ__UnitData_Module["移动"]))) {
					反击起点 = AI.params.get("counter_point");
					AI.params.set("back_to_counter_point", true);
			...
			if (((目标 != undefined))&&(目标.is_alive_ex())&&((反击起点 != undefined))&&((AI.unit.get_scene_point().get_scene() == 反击起点.get_scene()))&&((AI.unit.get_scene_point().distance(反击起点) > 追击距离))) {
	...
	//$$spark_core.ai.沿路线前进ai.AIBehavior_2:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_143910259:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		...
		if (((AI.unit.has_module(_OBJ__UnitData_Module["移动"]) && (战斗移动点 != undefined)))) {
			if (((AI.unit.get_scene_point().get_scene() == 战斗移动点.get_scene()))&&((AI.unit.get_scene_point().distance(战斗移动点) > (AI.attack_range + 128)))&&((战斗移动点.is_block() == false))&&((要施放的技能 == undefined))) {
	...
	//$$spark_core.ai.沿路线前进ai.AIBehavior_3:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_96471359:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 目标: Unit | undefined = AI.params.get("target_unit");
		let 技能: Skill | undefined = AI.params.get("next_skill");
		let 新技能: Skill | undefined;
		let 技能计时器: Timer | undefined;
		if ((((目标 != undefined) && (技能 == undefined) && (AI.unit.get_scene_name() == 目标.get_scene_name())))) {
	...
	//$$spark_core.ai.沿路线前进ai.AIBehavior_4:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_160602573:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 技能: Skill | undefined = AI.params.get("next_skill");
		let 目标: Unit | undefined = AI.params.get("target_unit");
	...
	//$$spark_core.ai.沿路线前进ai.AIBehavior_5:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_215516772:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 目标: Unit | undefined = AI.params.get("target_unit");
		let 反击起点: Point | undefined = AI.params.get("counter_point");
		let 追击距离: number | undefined = AI.params.get("pursue_distance");
		...
		let new_angle: number = 0;
		let new_point: Point = AI.unit.get_scene_point();
		if ((((目标 == undefined) || (目标.is_valid() == false)))) {
			return false;
		} else {
		}
		...
		if (((search_dis < 300))) {
			if (((目标.get_scene_point().get_scene() == AI.unit.get_scene_point().get_scene()))&&((目标.get_scene_point().distance(AI.unit.get_scene_point()) > search_dis))) {
		...
		// 大于一半的搜敌范围 也算了
		if (((目标.get_scene_point().get_scene() == AI.unit.get_scene_point().get_scene()))&&((目标.get_scene_point().distance(AI.unit.get_scene_point()) > (search_dis * 0.5)))) {
			return false;
		} else {
		}
		// 判一下场景是否相等
		if (((目标.get_scene_point().get_scene() != AI.unit.get_scene_point().get_scene()))) {
			return false;
		} else {
		}
	...
	//$$spark_core.ai.沿路线前进ai.AIBehavior_6:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_242771:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let 新变量: lib_common_ai.AI;
		let result: boolean = false;
		let 目标: Unit | undefined = AI.params.get("target_unit");
		...
		if (((目标 == undefined))&&((发呆计时器 == undefined))&&(AI.unit.has_module(_OBJ__UnitData_Module["移动"]))&&((目标点 != undefined))&&((AI.unit.get_scene_point().get_scene() == 目标点.get_scene()))&&((AI.unit.get_scene_point().distance(目标点) > 50))) {
			AI.unit.clean_command();
	...
	//$$spark_core.ai.沿路线前进ai.AIBehavior_7:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_230485642:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 目标点: Point | undefined = AI.params.get("target_point");
		...
		let 超过目标点: boolean = AI.params.get("exceed_target");
		// 到达目标点 判断发呆 判断是否到达最终点 判断是否循环
		AI.params.set("exceed_target", undefined);
		if ((((超过目标点 == true) || ((AI.unit.get_scene_point().get_scene() == 目标点.get_scene()) && (AI.unit.get_scene_point().distance(目标点) < 50) && (AI.params.get("target_unit") == undefined))))) {
			...
			if (((下标 < (路径点数组.length - 1)))) {
				下标 = (下标 + 1);
				AI.params.set("next_point", 路径点数组[下标]);
			} else {
				if ((((是否循环 == undefined) || (是否循环 == false)))) {
				} else {
					下标 = 0;
	...
	//$$spark_core.ai.沿路线前进ai.AIBehavior_8:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_170334925:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
	...
	//$$spark_core.ai.沿路线前进ai.root:Data.Game.OnAdd
	/** 
	 * @name func
	 * @noSelf */
	export let validator_213132334:(this: void, AI:lib_common_ai.AI)=>void = (this: void, AI:lib_common_ai.AI):void => {
		...
		for (let index of $range(1, path_length, 1)) {
		...
		// 上一个目标点
		AI.params.set("last_point", AI.unit.get_scene_point());
	}

	//$$spark_core.ai.沿路线前进ai.root:Data.Game.OnProvoke
	/** 
	 * @name func
	 * @noSelf */
	export let validator_243771185:(this: void, AI:lib_common_ai.AI, 发出刺激的单位:Unit, 激怒预期:boolean, 逃跑预期:boolean)=>void = (this: void, AI:lib_common_ai.AI, 发出刺激的单位:Unit, 激怒预期:boolean, 逃跑预期:boolean):void => {
		let 发呆计时器: Timer | undefined = AI.params.get("daze_timer");
	...
	//$$spark_core.ai.自定义AI样例.AIBehavior:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_199302381:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		AI.unit.clean_recast();
		if (((AI.unit.has_restriction_custom(单位状态["失控"]) || AI.unit.has_restriction_custom(单位状态["隐藏"]) || AI.is_casting(AI.unit) || (AI.params.get("master") == undefined)))) {
			return true;
		} else {
		}
		return result;
	...
	//$$spark_core.ai.自定义AI样例.AIBehavior_1:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_93988750:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 目标: Unit | undefined = AI.params.get("target_unit");
	...
	//$$spark_core.ai.自定义AI样例.AIBehavior_2:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_177931605:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 战斗移动点: Point | undefined = AI.params.get("order_move");
		let 要施放的技能: Skill | undefined = AI.params.get("next_skill");
		if (((AI.unit.has_module(_OBJ__UnitData_Module["移动"]) && (战斗移动点 != undefined)))) {
			if (((AI.unit.get_scene_point().get_scene() == 战斗移动点.get_scene()))&&((AI.unit.get_scene_point().distance(战斗移动点) > 50))&&((战斗移动点.is_block_ex() == false))) {
	...
	//$$spark_core.ai.自定义AI样例.AIBehavior_3:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_258570479:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 目标: Unit | undefined = AI.params.get("target_unit");
		let 技能: Skill | undefined = AI.params.get("next_skill");
		let 新技能: Skill | undefined;
	...
	//$$spark_core.ai.自定义AI样例.AIBehavior_4:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_260043675:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 技能: Skill | undefined = AI.params.get("next_skill");
		let 目标: Unit | undefined = AI.params.get("target_unit");
		let 成功施法技能: boolean = false;
	...
	//$$spark_core.ai.自定义AI样例.AIBehavior_5:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_95332923:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let 反击起点: Point | undefined;
		let result: boolean = false;
		let 目标: Unit | undefined = AI.params.get("target_unit");
		let search_dis: number = 0;
		let new_angle: number = 0;
		...
		// 小于三百就认为是近战单位 ai就不瞎走了 改为追击目标
		if (((search_dis < 300))) {
			if (((目标.get_scene_name() == AI.unit.get_scene_name()))&&((目标.get_scene_point().distance(AI.unit.get_scene_point()) > search_dis))) {
				new_angle = 目标.get_scene_point().angle(AI.unit.get_scene_point());
				new_point = 目标.get_scene_point().polar_to_ex(new_angle, (search_dis - 50));
		...
		// 大于一半的搜敌范围 也算了
		if (((目标.get_scene_name() == AI.unit.get_scene_name()))&&((目标.get_scene_point().distance(AI.unit.get_scene_point()) > (search_dis * 0.5)))) {
			return false;
		} else {
		}
		if (((目标.get_scene_name() == 主人.get_scene_name()))) {
	...
	//$$spark_core.ai.自定义AI样例.AIBehavior_6:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_139726900:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 主人: Unit | undefined = AI.params.get("master");
	...
	//$$spark_core.ai.自定义AI样例.AIBehavior_7:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_170633122:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
	...
	//$$spark_core.ai.自定义AI样例.AIBehavior_9:Data.Game.Behavior
	/** 
	 * @name func
	 * @noSelf */
	export let validator_164974595:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 主人: Unit | undefined = AI.params.get("master");
		let 巡逻距离: number = AI.params.get("patrol_range");
		let 搜敌距离: number = AI.params.get("search_range");
	...
	//$$spark_core.ai.自定义AI样例.root:Data.Game.OnAdd
	/** 
	 * @name func
	 * @noSelf */
	export let validator_27625786:(this: void, AI:lib_common_ai.AI)=>void = (this: void, AI:lib_common_ai.AI):void => {
		// 上次巡逻的时间
		AI.params.set("last_patrol_time", base.clock());
		// 巡逻频率
	...
	//$$spark_core.ai.自定义AI样例.root:Data.Game.OnRemove
	/** 
	 * @name func
	 * @noSelf */
	export let validator_6213429:(this: void, AI:lib_common_ai.AI)=>void = (this: void, AI:lib_common_ai.AI):void => {
	...
	//$$.template@effect.EffectPolarOffset.root:Data.Game.PeriodChangeIndex
	//$$default_units_ts.effect.击退.PolarOffset_1:Data.Game.PeriodChangeIndex
	//$$default_units_ts.spell.冰霜球.EffectPolarOffset:Data.Game.PeriodChangeIndex
	//$$default_units_ts.spell.召唤水元素.PolarOffset_1:Data.Game.PeriodChangeIndex
	//$$default_units_ts.spell.后撤步.PolarOffset:Data.Game.PeriodChangeIndex
	//$$default_units_ts.spell.后撤步.PolarOffset_1:Data.Game.PeriodChangeIndex
	//$$default_units_ts.spell.后撤步.PolarOffset_3:Data.Game.PeriodChangeIndex
	//$$default_units_ts.spell.后撤步.PolarOffset_4:Data.Game.PeriodChangeIndex
	//$$default_units_ts.spell.移形换影.PolarOffset_1:Data.Game.PeriodChangeIndex
	//$$default_units_ts.spell.通用攻击-三连击.PolarOffset:Data.Game.PeriodChangeIndex
	//$$default_units_ts.spell.钩锁.PolarOffset_1:Data.Game.PeriodChangeIndex
	//$$default_units_ts.unit.不死鸟.PolarOffset:Data.Game.PeriodChangeIndex
	//$$default_units_ts.unit.复仇恶灵.EffectPolarOffset:Data.Game.PeriodChangeIndex
	//$$default_units_ts.unit.暗影刺客.EffectPolarOffset:Data.Game.PeriodChangeIndex
	//$$default_units_ts.unit.海洋猎人.PolarOffset:Data.Game.PeriodChangeIndex
	//$$default_units_ts.unit.防御塔-向量穿透塔_1.PolarOffset_1:Data.Game.PeriodChangeIndex
	/** 
	 * @name func
	 * @noSelf */
	export let validator_265007906:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let cache: _OBJ__effect_EffectPersistLoop = 效果节点.parent.cache;
	...
	//$$spark_core.template@func_ref.优先符合过滤的单位.root:Data.Game.Func
	/** 
	 * @name func
	 * @noSelf */
	...
	//$$spark_core.func_ref.lowest_health_rate_unit.root:Data.Game.Func
	/** 
	 * @name func
	 * @noSelf */
	...
	//$$spark_core.func_ref.nearest_unit_to_caster.root:Data.Game.Func
	/** 
	 * @name func
	 * @noSelf */
	...
	//$$spark_core.func_ref.nearest_unit_to_target.root:Data.Game.Func
	/** 
	 * @name func
	 * @noSelf */
	...
	//$$spark_core.func_ref.优先上次施法的目标.root:Data.Game.Func
	/** 
	 * @name func
	 * @noSelf */
	export let validator_226870051:(this: void, 效果节点:EffectParam, 单位A:Unit, 单位B:Unit, 过滤函数Id:IdPreset<"func_ref_id">)=>number = (this: void, 效果节点:EffectParam, 单位A:Unit, 单位B:Unit, 过滤函数Id:IdPreset<"func_ref_id">):number => {
		let result: number = 1;
	...
	//$$spark_core.func_ref.优先剩余时间长的Buff.root:Data.Game.Func
	/** 
	 * @name func
	 * @noSelf */
	export let validator_21232577:(this: void, Buff1:Buff, Buff2:Buff)=>number = (this: void, Buff1:Buff, Buff2:Buff):number => {
	...
	//$$spark_core.func_ref.优先施法者正前方120度内的单位.root:Data.Game.Func
	/** 
	 * @name func
	 * @noSelf */
	...
	//$$spark_core.func_ref.优先来自英雄的Buff.root:Data.Game.Func
	/** 
	 * @name func
	 * @noSelf */
	export let validator_157653182:(this: void, Buff1:Buff, Buff2:Buff)=>number = (this: void, Buff1:Buff, Buff2:Buff):number => {
	...
	//$$spark_core.func_ref.优先高等级的Buff.root:Data.Game.Func
	/** 
	 * @name func
	 * @noSelf */
	export let validator_233470208:(this: void, Buff1:Buff, Buff2:Buff)=>number = (this: void, Buff1:Buff, Buff2:Buff):number => {
	...
	//$$spark_core.func_ref.随机的单位.root:Data.Game.Func
	/** 
	 * @name func
	 * @noSelf */
	 ...
	 * @name func
	 * @noSelf */
	export let validator_147940717:(this: void, 伤害来源:Unit, 伤害目标:Unit, 效果节点:EffectParam, 伤害实例:DamageInstance)=>number = (this: void, 伤害来源:Unit, 伤害目标:Unit, 效果节点:EffectParam, 伤害实例:DamageInstance):number => {
	 ...
	 * @name func
	 * @noSelf */
	export let validator_182033581:(this: void, X轴数值:number, Y轴数值:number, 主控单位:Unit)=>void = (this: void, X轴数值:number, Y轴数值:number, 主控单位:Unit):void => {
		if (((主控单位.get_ride_unit() != undefined))) {
	 ...
	 * @name func
	 * @noSelf */
	export let validator_226425550:(this: void, 主控单位:Unit)=>void = (this: void, 主控单位:Unit):void => {
		let Y轴数值: number = 0;
		let X轴数值: number = 0;
		if (((主控单位.get_ride_unit() != undefined))) {
	...
	//$$.template@spell.spell.root:Data.Game.Formulas.Mana
	//$$spark_core.template@spell.被动法球技能节点.root:Data.Game.Formulas.Mana
	//$$spark_core.template@spell.通用近战普攻模版.root:Data.Game.Formulas.Mana
	//$$spark_core.template@spell.防御塔攻击模板.root:Data.Game.Formulas.Mana
	//$$default_units_ts.spell.Roll.root:Data.Game.Formulas.Mana
	...
	//$$default_units_ts.spell.转向施法样例.root:Data.Game.Formulas.Mana
	...
	//$$default_units_ts.spell.预警陨石.root:Data.Game.Formulas.Mana
	...
	//$$default_units_ts.spell.默认骑乘交互.root:Data.Game.Formulas.Mana
	//$$default_units_ts.spell.默认骑乘结束.root:Data.Game.Formulas.Mana
	 ...
	 * @name func
	 * @noSelf */
	export let validator_233319472:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		...
		let result: number = (((spell.get_owner().get_ex(单位属性["魔法上限"], UnitPropertySubType["Final"]) * cache.Cost.ManaFraction) / 100) + cache.Cost.Mana);
		let config: _OBJ__SkillPhaseConfig | undefined;
		if (((is_combo == true))) {
			config = cache.MultiPhaseSetting.MultiPhaseConfig[(combo - 1)];
			result = (((spell.get_owner().get_ex(单位属性["魔法上限"], UnitPropertySubType["Final"]) * config.ManaFraction) / 100) + config.Mana);
		} else {
		}
		return result;
	}
	...
	//$$.template@spell.spell.root:Data.Game.Formulas.Cooldown
	//$$spark_core.template@spell.被动法球技能节点.root:Data.Game.Formulas.Cooldown
	//$$default_units_ts.spell.Roll.root:Data.Game.Formulas.Cooldown
	...
	//$$default_units_ts.spell.转向施法样例.root:Data.Game.Formulas.Cooldown
	...
	//$$default_units_ts.spell.预警陨石.root:Data.Game.Formulas.Cooldown
	...
	//$$default_units_ts.spell.默认骑乘交互.root:Data.Game.Formulas.Cooldown
	//$$default_units_ts.spell.默认骑乘结束.root:Data.Game.Formulas.Cooldown
	...
	//$$.template@spell.spell.root:Data.Game.Formulas.ChargeMax
	//$$spark_core.template@spell.被动法球技能节点.root:Data.Game.Formulas.ChargeMax
	//$$spark_core.template@spell.通用近战普攻模版.root:Data.Game.Formulas.ChargeMax
	//$$spark_core.template@spell.防御塔攻击模板.root:Data.Game.Formulas.ChargeMax
	//$$default_units_ts.spell.Roll.root:Data.Game.Formulas.ChargeMax
	...
	//$$default_units_ts.spell.转向施法样例.root:Data.Game.Formulas.ChargeMax
	...
	//$$default_units_ts.spell.预警陨石.root:Data.Game.Formulas.ChargeMax
	...
	//$$default_units_ts.spell.默认骑乘交互.root:Data.Game.Formulas.ChargeMax
	//$$default_units_ts.spell.默认骑乘结束.root:Data.Game.Formulas.ChargeMax
	 ...
	 * @name func
	 * @noSelf */
	export let validator_56562507:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let spell: Skill = 效果节点.skill();
		let cache: _OBJ__spell_spell = spell.cache;
	...
	//$$.template@spell.spell.root:Data.Game.Formulas.Range
	//$$spark_core.template@spell.被动法球技能节点.root:Data.Game.Formulas.Range
	//$$spark_core.template@spell.通用近战普攻模版.root:Data.Game.Formulas.Range
	//$$spark_core.template@spell.防御塔攻击模板.root:Data.Game.Formulas.Range
	//$$default_units_ts.spell.Roll.root:Data.Game.Formulas.Range
	...
	//$$default_units_ts.spell.转向施法样例.root:Data.Game.Formulas.Range
	...
	//$$default_units_ts.spell.预警陨石.root:Data.Game.Formulas.Range
	...
	//$$default_units_ts.spell.默认骑乘交互.root:Data.Game.Formulas.Range
	//$$default_units_ts.spell.默认骑乘结束.root:Data.Game.Formulas.Range
	 ...
	 * @name func
	 * @noSelf */
	export let validator_83540934:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let spell: Skill = 效果节点.skill();
		let cache: _OBJ__spell_spell = spell.cache;
	...
	//$$.template@spell.spell.root:Data.Game.Formulas.Time
	//$$spark_core.template@spell.被动法球技能节点.root:Data.Game.Formulas.Time
	//$$default_units_ts.spell.Roll.root:Data.Game.Formulas.Time
	...
	//$$default_units_ts.spell.转向施法样例.root:Data.Game.Formulas.Time
	...
	//$$default_units_ts.spell.预警陨石.root:Data.Game.Formulas.Time
	...
	//$$default_units_ts.spell.默认骑乘交互.root:Data.Game.Formulas.Time
	//$$default_units_ts.spell.默认骑乘结束.root:Data.Game.Formulas.Time
	 ...
	 * @name func
	 * @noSelf */
	export let validator_12509021:(this: void, 效果节点:EffectParam, 阶段:number)=>number = (this: void, 效果节点:EffectParam, 阶段:number):number => {
		let spell: Skill = 效果节点.skill();
		let cache: _OBJ__spell_spell = spell.cache;
		let is_combo: boolean = cache.MultiPhaseSetting.IsMultiPhase;
		let combo: number = base.eff_param_cast_phase(效果节点);
		let hasteProp: _OBJ__Spell_attack_speed_attribute = cache.AttributeHaste;
		let caster: Unit | undefined = base.eff_param_caster(效果节点);
		...
		if (((is_combo == true))) {
			s[0] = cache.MultiPhaseSetting.MultiPhaseConfig[(combo - 1)].SpellTime.cast_start_time;
			s[1] = cache.MultiPhaseSetting.MultiPhaseConfig[(combo - 1)].SpellTime.cast_channel_time;
			s[2] = cache.MultiPhaseSetting.MultiPhaseConfig[(combo - 1)].SpellTime.cast_shot_time;
			s[3] = cache.MultiPhaseSetting.MultiPhaseConfig[(combo - 1)].SpellTime.cast_finish_time;
		} else {
			s[0] = cache.Time.cast_start_time;
			s[1] = cache.Time.cast_channel_time;
			s[2] = cache.Time.cast_shot_time;
			s[3] = cache.Time.cast_finish_time;
		}
		s_current = s[(阶段 - 1)];
		if (((s_current <= 0))) {
			return 0;
	...
	//$$.item.test_potion_heal.SpellRootInstant_1:Data.Game.Formulas.ChargeCooldown
	//$$.template@spell.Spell.root:Data.Game.Formulas.ChargeCooldown
	//$$.template@spell.SpellAttackModifier.root:Data.Game.Formulas.ChargeCooldown
	//$$.template@spell.SpellBuild.root:Data.Game.Formulas.ChargeCooldown
	//$$.template@spell.SpellFish.root:Data.Game.Formulas.ChargeCooldown
	//$$.template@spell.SpellMorph.root:Data.Game.Formulas.ChargeCooldown
	//$$.template@spell.SpellRootCircle.root:Data.Game.Formulas.ChargeCooldown
	//$$.template@spell.SpellRootInstant.root:Data.Game.Formulas.ChargeCooldown
	//$$.template@spell.SpellRootPassive.root:Data.Game.Formulas.ChargeCooldown
	//$$.template@spell.SpellRootUnit.root:Data.Game.Formulas.ChargeCooldown
	//$$.template@spell.SpellRootUnitOrCircle.root:Data.Game.Formulas.ChargeCooldown
	//$$.template@spell.SpellRootVector.root:Data.Game.Formulas.ChargeCooldown
	//$$.template@spell.SpellToggle.root:Data.Game.Formulas.ChargeCooldown
	//$$.template@spell.spell.root:Data.Game.Formulas.ChargeCooldown
	//$$spark_core.template@spell.被动法球技能节点.root:Data.Game.Formulas.ChargeCooldown
	//$$spark_core.template@spell.通用近战普攻模版.root:Data.Game.Formulas.ChargeCooldown
	//$$spark_core.template@spell.防御塔攻击模板.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.Roll.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.[难度1]-目标火球.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.三火球.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.不死鸟.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.不死鸟灼伤.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.修理.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.元素凝聚.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.元素激流.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.冰霜球.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.冲锋陷阵.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.净化.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.减速法球.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.刀扇.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.剑刃风暴.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.占据.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.反噬（被动）.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.召唤水元素.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.后撤步.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.吞噬魔法.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.吸血光环.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.咆哮.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.嘲讽.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.回春.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.圣光斗篷.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.圣光术.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.地震.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.坚韧光环.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.复活.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.天神下凡.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.寄生虫.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.巫毒狂舞.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.建造技能.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.弱化之锤.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.弹无虚发.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.心灵之火.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.怒吼.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.感应地雷.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.成长火球.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.战争践踏.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.战吼.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.控制魔法.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.放逐.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.旋转碰撞回旋镖（被动）.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.旋风斩.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.无敌圣盾.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.无敌（被动）.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.无限蓄力火球.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.暴击法球.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.暴风雪.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.横扫.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.治疗术.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.治疗波.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.治疗结界.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.法力虹吸.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.流星火雨.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.火球术.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.炉石.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.盾击.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.硬化体肤（被动）.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.祝福圣光.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.移形换影.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.穿刺.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.群体减速.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.肉勾.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.虔诚光环.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.蛇棒攻击.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.血焰之剑.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.血焰之剑（蓄力版本）.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.诅咒.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.诱捕.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.转向施法样例.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.迷雾.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.通用攻击-三连击.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.通用攻击-刀光.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.通用攻击-劈砍.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.通用攻击-戳刺.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.通用攻击-火球.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.邪恶狂热.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.重生.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.野蛮跳跃.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.钩锁.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.镜像.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.闪现.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.闪电之盾.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.闪电链.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.防反.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.防御光环.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.隐身术.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.雷霆一击.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.震荡波.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.霜甲术.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.静滞陷阱.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.预警陨石.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.风暴之锤.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.驱散魔法.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.魔法侦测（被动）.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.魔法免疫（被动）.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.魔法免疫（被动）_1.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.魔法防御（可开关）.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.默认目标交互.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.默认骑乘交互.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.spell.默认骑乘结束.root:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.6、远程普攻示例英雄.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.sce2号.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.sce2号.SpellRootVector_2:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.不死鸟.SpellToggle:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.复仇恶灵.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.复仇恶灵.Spell_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.复仇恶灵.Spell_2:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.复仇恶灵.Spell_3:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.恶斧.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.恶斧.Spell_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.恶斧.Spell_2:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.感应地雷.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.感应地雷.Spell_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.撼地神牛.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.撼地神牛.Spell_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.撼地神牛.Spell_3:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.无上法师.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.无上法师.Spell_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.无上法师.Spell_2:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.无上法师.Spell_3:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.无上法师.Spell_4:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.无人机.SpellRootVector_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.暗影刺客.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.暗影刺客.Spell_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.暗影刺客.Spell_2:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.海洋猎人.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.海洋猎人.Spell_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.海洋猎人.Spell_2:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.火龙.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.火龙.SpellRootVector_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.火龙.SpellRootVector_2:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.火龙.Spell_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.爬虫.SpellRootVector_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.狼人.SpellRootCircle_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.狼人.SpellRootInstant_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.秃鹫.SpellRootCircle_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.秃鹫.SpellRootCircle_1_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.群体范围塔_1.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.远古战士.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.远古战士.Spell_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.远古战士.Spell_3:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.远古战士.Spell_4:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.远古战士.Spell_5:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.远古战士.Spell_6:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.邪恶屠夫.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.邪恶屠夫.SpellToggle:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.邪恶屠夫.SpellToggle_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.野猪.SpellRootCircle_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.野猪.SpellRootVector_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.防御塔-光环塔_1.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.防御塔-单体减速塔_1.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.防御塔-向量穿透塔_1.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.雷神.Spell:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.雷神.Spell_1:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.雷神.Spell_2:Data.Game.Formulas.ChargeCooldown
	//$$default_units_ts.unit.雷神.Spell_3:Data.Game.Formulas.ChargeCooldown
	/** 
	 * @name func
	 * @noSelf */
	export let validator_64459937:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let spell: Skill = 效果节点.skill();
		let cache: _OBJ__spell_Spell = spell.cache;
		let result: number = cache.Cost.ChargeCool;
		return result;
	}

	//$$spark_core.template@spell.通用近战普攻模版.Damage_1:Data.Game.Amount
	...
	//$$spark_core.template@spell.通用近战普攻模版.root:Data.Game.Formulas.Cooldown
	//$$spark_core.template@spell.防御塔攻击模板.root:Data.Game.Formulas.Cooldown
	 ...
	 * @name func
	 * @noSelf */
	export let validator_91593426:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let spell: Skill = 效果节点.skill();
		let cache: _OBJ__spell_spell = spell.cache;
		let is_combo: boolean = cache.MultiPhaseSetting.IsMultiPhase;
		let combo: number = spell.phase;
	...
	//$$spark_core.template@spell.通用近战普攻模版.root:Data.Game.Formulas.Time
	//$$spark_core.template@spell.防御塔攻击模板.root:Data.Game.Formulas.Time
	 ...
	 * @name func
	 * @noSelf */
	export let validator_84202342:(this: void, 效果节点:EffectParam, 阶段:number)=>number = (this: void, 效果节点:EffectParam, 阶段:number):number => {
		let spell: Skill = 效果节点.skill();
		let cache: _OBJ__spell_spell = spell.cache;
		let is_combo: boolean = cache.MultiPhaseSetting.IsMultiPhase;
		let combo: number = spell.phase;
	...
	//$$default_units_ts.spell.默认骑乘交互.CustomAction:Data.Game.Validators
	/** 
	 * @name func
	 * @noSelf */
	export let validator_219325151:(this: void, 效果节点:EffectParam)=>验证器代码 = (this: void, 效果节点:EffectParam):验证器代码 => {
		let 骑乘者: Unit = base.eff_param_caster(效果节点);
		let result: 验证器代码 = 验证器代码["OK"];
		if (((骑乘者.get_ride_unit() != undefined))) {
			result = 验证器代码["NothingToExecute"];
		} else {
		}
		return result;
	}

	//$$default_units_ts.spell.默认骑乘交互.CustomAction:Data.Game.Func
	/** 
	 * @name func
	 * @noSelf */
	export let validator_3959591:(this: void, 效果节点:EffectParam)=>boolean = (this: void, 效果节点:EffectParam):boolean => {
		let result: boolean = true;
		let 骑乘者: Unit = base.eff_param_caster(效果节点);
		let 坐骑: Unit = base.eff_param_main_target_unit(效果节点);
		log.info("交互发动", base.eff_param_caster(效果节点), base.eff_param_main_target_unit(效果节点));
		骑乘者.ride_on(坐骑, 骑乘者.get_string(单位字符串属性["骑乘目标绑点"]), 骑乘者.get_string(单位字符串属性["骑乘动画"]));
		return result;
	}

	//$$default_units_ts.spell.默认骑乘结束.CustomAction:Data.Game.Validators
	/** 
	 * @name func
	 * @noSelf */
	export let validator_142918539:(this: void, 效果节点:EffectParam)=>验证器代码 = (this: void, 效果节点:EffectParam):验证器代码 => {
		let 骑乘者: Unit = base.eff_param_caster(效果节点);
		let result: 验证器代码 = 验证器代码["OK"];
		if (((骑乘者.get_ride_unit() == undefined))) {
			result = 验证器代码["NothingToExecute"];
	...
	//$$default_units_ts.spell.默认骑乘结束.CustomAction:Data.Game.Func
	/** 
	 * @name func
	 * @noSelf */
	export let validator_219120192:(this: void, 效果节点:EffectParam)=>boolean = (this: void, 效果节点:EffectParam):boolean => {
		let result: boolean = true;
		let 骑乘者: Unit = base.eff_param_caster(效果节点);
		let 坐骑: Unit = base.eff_param_main_target_unit(效果节点);
		log.info("交互发动", base.eff_param_caster(效果节点), base.eff_param_main_target_unit(效果节点));
	...
	function init_validator_0() {
		...
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_240644303(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_1")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_104986873(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_10")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_243164383(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_11")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_75033395(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_2")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_39637044(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_3")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_95389468(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_4")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_9902169(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_5")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_76233091(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_6")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_42264203(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_7")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_47369300(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_8")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_179222928(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_9")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_230146962(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.testai.root")) {
			data.OnAdd = (this: void, ...args: any) => { let result = validator_48711270(...args); return result; }
			data.OnProvoke = (this: void, ...args: any) => { let result = validator_2653852(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.沿路线前进ai.AIBehavior")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_861644(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.沿路线前进ai.AIBehavior_1")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_122531029(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.沿路线前进ai.AIBehavior_2")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_143910259(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.沿路线前进ai.AIBehavior_3")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_96471359(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.沿路线前进ai.AIBehavior_4")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_160602573(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.沿路线前进ai.AIBehavior_5")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_215516772(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.沿路线前进ai.AIBehavior_6")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_242771(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.沿路线前进ai.AIBehavior_7")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_230485642(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.沿路线前进ai.AIBehavior_8")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_170334925(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.沿路线前进ai.root")) {
			data.OnAdd = (this: void, ...args: any) => { let result = validator_213132334(...args); return result; }
			data.OnProvoke = (this: void, ...args: any) => { let result = validator_243771185(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.自定义AI样例.AIBehavior")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_199302381(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.自定义AI样例.AIBehavior_1")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_93988750(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.自定义AI样例.AIBehavior_2")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_177931605(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.自定义AI样例.AIBehavior_3")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_258570479(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.自定义AI样例.AIBehavior_4")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_260043675(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.自定义AI样例.AIBehavior_5")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_95332923(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.自定义AI样例.AIBehavior_6")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_139726900(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.自定义AI样例.AIBehavior_7")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_170633122(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.自定义AI样例.AIBehavior_9")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_164974595(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.自定义AI样例.root")) {
			data.OnAdd = (this: void, ...args: any) => { let result = validator_27625786(...args); return result; }
			data.OnRemove = (this: void, ...args: any) => { let result = validator_6213429(...args); return result; }
		}
		if (data = base.eff.cache("$$.template@effect.EffectPolarOffset.root")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_265007906(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.effect.击退.PolarOffset_1")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_265007906(...args); return result; }
			data.Distance = (this: void, ...args: any) => { let result = validator_126068103(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.冰霜球.EffectPolarOffset")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_265007906(...args); return result; }
			data.Distance = (this: void, ...args: any) => { let result = validator_187397518(...args); return result; }
			data.Angle.LocalOffset = (this: void, ...args: any) => { let result = validator_101654218(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.召唤水元素.PolarOffset_1")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_265007906(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.后撤步.PolarOffset")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_265007906(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.后撤步.PolarOffset_1")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_265007906(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.后撤步.PolarOffset_3")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_265007906(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.后撤步.PolarOffset_4")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_265007906(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.移形换影.PolarOffset_1")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_265007906(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.通用攻击-三连击.PolarOffset")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_265007906(...args); return result; }
			data.Validators = (this: void, ...args: any) => { let result = validator_236127537(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.钩锁.PolarOffset_1")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_265007906(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.unit.不死鸟.PolarOffset")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_265007906(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.unit.复仇恶灵.EffectPolarOffset")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_265007906(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.unit.暗影刺客.EffectPolarOffset")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_265007906(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.unit.海洋猎人.PolarOffset")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_265007906(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.unit.防御塔-向量穿透塔_1.PolarOffset_1")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_265007906(...args); return result; }
		}
		if (data = base.eff.cache("$$.template@func_ref.FuncRefSortUnitBuff.root")) {
			data.Func = (this: void, ...args: any) => { let result = validator_33561757(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.template@func_ref.优先符合过滤的单位.root")) {
			data.Func = (this: void, ...args: any) => { let result = validator_99777765(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.func_ref.lowest_health_rate_unit.root")) {
			data.Func = (this: void, ...args: any) => { let result = validator_23451517(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.func_ref.nearest_unit_to_caster.root")) {
			data.Func = (this: void, ...args: any) => { let result = validator_97896931(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.func_ref.nearest_unit_to_target.root")) {
			data.Func = (this: void, ...args: any) => { let result = validator_248042905(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.func_ref.优先上次施法的目标.root")) {
			data.Func = (this: void, ...args: any) => { let result = validator_226870051(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.func_ref.优先剩余时间长的Buff.root")) {
			data.Func = (this: void, ...args: any) => { let result = validator_21232577(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.func_ref.优先施法者正前方120度内的单位.root")) {
			data.Func = (this: void, ...args: any) => { let result = validator_145515012(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.func_ref.优先来自英雄的Buff.root")) {
			data.Func = (this: void, ...args: any) => { let result = validator_157653182(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.func_ref.优先高等级的Buff.root")) {
			data.Func = (this: void, ...args: any) => { let result = validator_233470208(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.func_ref.随机的单位.root")) {
			data.Func = (this: void, ...args: any) => { let result = validator_180756668(...args); return result; }
		}
		if (data = base.eff.cache("$$.gameplay.dflt.default_units_ts_CureRule_1")) {
			data.FCureRule = (this: void, ...args: any) => { let result = validator_255597210(...args); return result; }
			data.FCriticalRule = (this: void, ...args: any) => { let result = validator_148805509(...args); return result; }
		}
		if (data = base.eff.cache("$$.gameplay.dflt.default_units_ts_DamageRule_3")) {
			data.FDamageRule = (this: void, ...args: any) => { let result = validator_34781199(...args); return result; }
			data.FCriticalRule = (this: void, ...args: any) => { let result = validator_189928549(...args); return result; }
		}
		if (data = base.eff.cache("$$.gameplay.dflt.default_units_ts_DamageRule_4")) {
			data.FDamageRule = (this: void, ...args: any) => { let result = validator_59680661(...args); return result; }
			data.FCriticalRule = (this: void, ...args: any) => { let result = validator_209125194(...args); return result; }
		}
		if (data = base.eff.cache("$$.gameplay.dflt.default_units_ts_DamageRule_5")) {
			data.FDamageRule = (this: void, ...args: any) => { let result = validator_22685921(...args); return result; }
			data.FCriticalRule = (this: void, ...args: any) => { let result = validator_191493992(...args); return result; }
		}
		if (data = base.eff.cache("$$.gameplay.dflt.default_units_ts_LeechRule")) {
			data.FLeechRule = (this: void, ...args: any) => { let result = validator_147940717(...args); return result; }
		}
		if (data = base.eff.cache("$$.gameplay.dflt.root")) {
			data.XPGrantRule.XPGrant = (this: void, ...args: any) => { let result = validator_44065067(...args); return result; }
			data.XPGrantRule.XPDistributionCheck = (this: void, ...args: any) => { let result = validator_166947453(...args); return result; }
			data.FProtoRequest = (this: void, ...args: any) => { let result = validator_182033581(...args); return result; }
			data.FProtoStopRequest = (this: void, ...args: any) => { let result = validator_226425550(...args); return result; }
		}
		if (data = base.eff.cache("$$.item.test_potion_heal.SpellRootInstant_1")) {
			data.Formulas.Mana = (this: void, ...args: any) => { let result = validator_233319472(...args); return result; }
			data.Formulas.Cooldown = (this: void, ...args: any) => { let result = validator_45417306(...args); return result; }
			data.Formulas.ChargeMax = (this: void, ...args: any) => { let result = validator_56562507(...args); return result; }
			data.Formulas.Range = (this: void, ...args: any) => { let result = validator_83540934(...args); return result; }
			data.Formulas.Time = (this: void, ...args: any) => { let result = validator_12509021(...args); return result; }
			data.Formulas.ChargeCooldown = (this: void, ...args: any) => { let result = validator_64459937(...args); return result; }
		}
		...
		if (data = base.eff.cache("$$spark_core.template@spell.被动法球技能节点.root")) {
			data.Formulas.Mana = (this: void, ...args: any) => { let result = validator_233319472(...args); return result; }
			data.Formulas.Cooldown = (this: void, ...args: any) => { let result = validator_45417306(...args); return result; }
			data.Formulas.ChargeMax = (this: void, ...args: any) => { let result = validator_56562507(...args); return result; }
			data.Formulas.Range = (this: void, ...args: any) => { let result = validator_83540934(...args); return result; }
		...
		if (data = base.eff.cache("$$spark_core.template@spell.通用近战普攻模版.root")) {
			data.Formulas.Mana = (this: void, ...args: any) => { let result = validator_233319472(...args); return result; }
			data.Formulas.ChargeMax = (this: void, ...args: any) => { let result = validator_56562507(...args); return result; }
			data.Formulas.Range = (this: void, ...args: any) => { let result = validator_83540934(...args); return result; }
			data.Formulas.ChargeCooldown = (this: void, ...args: any) => { let result = validator_64459937(...args); return result; }
			data.Formulas.Cooldown = (this: void, ...args: any) => { let result = validator_91593426(...args); return result; }
			data.Formulas.Time = (this: void, ...args: any) => { let result = validator_84202342(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.template@spell.防御塔攻击模板.root")) {
			data.Formulas.Mana = (this: void, ...args: any) => { let result = validator_233319472(...args); return result; }
			data.Formulas.ChargeMax = (this: void, ...args: any) => { let result = validator_56562507(...args); return result; }
			data.Formulas.Range = (this: void, ...args: any) => { let result = validator_83540934(...args); return result; }
			data.Formulas.ChargeCooldown = (this: void, ...args: any) => { let result = validator_64459937(...args); return result; }
		...
		if (data = base.eff.cache("$$default_units_ts.spell.Roll.root")) {
			data.Formulas.Mana = (this: void, ...args: any) => { let result = validator_233319472(...args); return result; }
			data.Formulas.Cooldown = (this: void, ...args: any) => { let result = validator_45417306(...args); return result; }
			data.Formulas.ChargeMax = (this: void, ...args: any) => { let result = validator_56562507(...args); return result; }
			data.Formulas.Range = (this: void, ...args: any) => { let result = validator_83540934(...args); return result; }
		...
		if (data = base.eff.cache("$$default_units_ts.spell.转向施法样例.root")) {
			data.Formulas.Mana = (this: void, ...args: any) => { let result = validator_233319472(...args); return result; }
			data.Formulas.Cooldown = (this: void, ...args: any) => { let result = validator_45417306(...args); return result; }
			data.Formulas.ChargeMax = (this: void, ...args: any) => { let result = validator_56562507(...args); return result; }
			data.Formulas.Range = (this: void, ...args: any) => { let result = validator_83540934(...args); return result; }
		...
		if (data = base.eff.cache("$$default_units_ts.spell.预警陨石.root")) {
			data.Formulas.Mana = (this: void, ...args: any) => { let result = validator_233319472(...args); return result; }
			data.Formulas.Cooldown = (this: void, ...args: any) => { let result = validator_45417306(...args); return result; }
			data.Formulas.ChargeMax = (this: void, ...args: any) => { let result = validator_56562507(...args); return result; }
			data.Formulas.Range = (this: void, ...args: any) => { let result = validator_83540934(...args); return result; }
		...
		if (data = base.eff.cache("$$default_units_ts.spell.默认骑乘交互.root")) {
			data.Formulas.Mana = (this: void, ...args: any) => { let result = validator_233319472(...args); return result; }
			data.Formulas.Cooldown = (this: void, ...args: any) => { let result = validator_45417306(...args); return result; }
			data.Formulas.ChargeMax = (this: void, ...args: any) => { let result = validator_56562507(...args); return result; }
			data.Formulas.Range = (this: void, ...args: any) => { let result = validator_83540934(...args); return result; }
		...
		if (data = base.eff.cache("$$default_units_ts.spell.默认骑乘结束.root")) {
			data.Formulas.Mana = (this: void, ...args: any) => { let result = validator_233319472(...args); return result; }
			data.Formulas.Cooldown = (this: void, ...args: any) => { let result = validator_45417306(...args); return result; }
			data.Formulas.ChargeMax = (this: void, ...args: any) => { let result = validator_56562507(...args); return result; }
			data.Formulas.Range = (this: void, ...args: any) => { let result = validator_83540934(...args); return result; }
	...
	function init_validator_1() {
		...
		if (data = base.eff.cache("$$default_units_ts.spell.无限蓄力火球.root")) {
			data.Formulas.Cooldown = (this: void, ...args: any) => { let result = validator_45417306(...args); return result; }
			data.Formulas.ChargeCooldown = (this: void, ...args: any) => { let result = validator_64459937(...args); return result; }
			data.Formulas.Mana = (this: void, ...args: any) => { let result = validator_67644446(...args); return result; }
			data.Formulas.ChargeMax = (this: void, ...args: any) => { let result = validator_211391127(...args); return result; }
			data.Formulas.Range = (this: void, ...args: any) => { let result = validator_63878418(...args); return result; }
			data.Formulas.Time = (this: void, ...args: any) => { let result = validator_20649543(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.unit.sce2号.Spell")) {
			data.Formulas.ChargeCooldown = (this: void, ...args: any) => { let result = validator_64459937(...args); return result; }
			data.Formulas.Mana = (this: void, ...args: any) => { let result = validator_117687348(...args); return result; }
			data.Formulas.Cooldown = (this: void, ...args: any) => { let result = validator_155076026(...args); return result; }
			data.Formulas.ChargeMax = (this: void, ...args: any) => { let result = validator_117198562(...args); return result; }
			data.Formulas.Range = (this: void, ...args: any) => { let result = validator_146821332(...args); return result; }
			data.Formulas.Time = (this: void, ...args: any) => { let result = validator_14977813(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.template@spell.通用近战普攻模版.Damage_1")) {
			data.Amount = (this: void, ...args: any) => { let result = validator_196209676(...args); return result; }
		}
		...
		if (data = base.eff.cache("$$default_units_ts.spell.三火球.PolarOffset_1")) {
			data.PeriodChangeIndex = (this: void, ...args: any) => { let result = validator_204988239(...args); return result; }
		}
		...
		if (data = base.eff.cache("$$default_units_ts.spell.不死鸟.Set_1")) {
			data.Validators = (this: void, ...args: any) => { let result = validator_208749477(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.元素激流.CustomAction_2")) {
			data.Func = (this: void, ...args: any) => { let result = validator_40290592(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.元素激流.CustomAction_3")) {
			data.Func = (this: void, ...args: any) => { let result = validator_171995275(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.元素激流.Search_2")) {
			data.SearchValidators = (this: void, ...args: any) => { let result = validator_27087888(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.冲锋陷阵.LaunchMissileDash_1")) {
			data.Speed = (this: void, ...args: any) => { let result = validator_236306566(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.净化.Damage_1")) {
			data.Validators = (this: void, ...args: any) => { let result = validator_196723837(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.剑刃风暴.ResponseEffectImpact")) {
			data.Validator = (this: void, ...args: any) => { let result = validator_219498177(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.后撤步.LaunchMissileDash_1")) {
			data.Speed = (this: void, ...args: any) => { let result = validator_220220686(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.吞噬魔法.Set_2")) {
			data.Validators = (this: void, ...args: any) => { let result = validator_130739784(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.吸血光环.ResponseDamageAttacker_1")) {
			data.Validator = (this: void, ...args: any) => { let result = validator_154180313(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.吸血光环.UnitModifyAttribute")) {
			data.KeyValuePairs[1].Value = (this: void, ...args: any) => { let result = validator_243543281(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.怒吼.ResponseDamageDefender_1")) {
			data.Multiplier = (this: void, ...args: any) => { let result = validator_58691808(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.旋转碰撞回旋镖（被动）.EffectSet")) {
			data.Validators = (this: void, ...args: any) => { let result = validator_76703967(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.旋转碰撞回旋镖（被动）.EffectSwitch")) {
			data.CaseArray[1].Validator = (this: void, ...args: any) => { let result = validator_110577815(...args); return result; }
			data.CaseArray[2].Validator = (this: void, ...args: any) => { let result = validator_69151185(...args); return result; }
			data.CaseArray[3].Validator = (this: void, ...args: any) => { let result = validator_153290600(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.旋风斩.ResponseEffectImpact")) {
			data.Validator = (this: void, ...args: any) => { let result = validator_149816263(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.无限蓄力火球.CustomAction")) {
			data.Func = (this: void, ...args: any) => { let result = validator_190311381(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.无限蓄力火球.EffectLaunchMissile")) {
			data.ImpactSearchRange = (this: void, ...args: any) => { let result = validator_12576726(...args); return result; }
			data.MissileScaling = (this: void, ...args: any) => { let result = validator_142703019(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.无限蓄力火球.PolarOffset")) {
			data.Distance = (this: void, ...args: any) => { let result = validator_111053058(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.治疗波.CustomAction_1")) {
			data.Func = (this: void, ...args: any) => { let result = validator_56366968(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.治疗波.CustomAction_2")) {
			data.Func = (this: void, ...args: any) => { let result = validator_108653932(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.治疗波.Search_1")) {
			data.SearchValidators = (this: void, ...args: any) => { let result = validator_34088597(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.治疗波.UnitModifyAttribute_1")) {
			data.KeyValuePairs[1].Value = (this: void, ...args: any) => { let result = validator_157054375(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.法力虹吸.AddBuff_1")) {
			data.Validators = (this: void, ...args: any) => { let result = validator_157541609(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.法力虹吸.AddBuff_2")) {
			data.Validators = (this: void, ...args: any) => { let result = validator_67885651(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.血焰之剑（蓄力版本）.EffectDamage_1")) {
			data.Amount = (this: void, ...args: any) => { let result = validator_126854600(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.通用攻击-三连击.Buff")) {
			data.PersistValidator = (this: void, ...args: any) => { let result = validator_20859394(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.通用攻击-三连击.Damage")) {
			data.Amount = (this: void, ...args: any) => { let result = validator_51649446(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.通用攻击-刀光.Damage_1")) {
			data.Amount = (this: void, ...args: any) => { let result = validator_223462450(...args); return result; }
		}
		...
		if (data = base.eff.cache("$$default_units_ts.spell.通用攻击-刀光.ResponseEffectImpact")) {
			data.Validator = (this: void, ...args: any) => { let result = validator_189007863(...args); return result; }
		}
		...
		if (data = base.eff.cache("$$default_units_ts.spell.通用攻击-劈砍.Damage_1")) {
			data.Amount = (this: void, ...args: any) => { let result = validator_19086676(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.通用攻击-劈砍.ResponseEffectImpact")) {
			data.Validator = (this: void, ...args: any) => { let result = validator_259665378(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.通用攻击-戳刺.Damage_1")) {
			data.Amount = (this: void, ...args: any) => { let result = validator_120343679(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.重生.Switch_1")) {
			data.CaseArray[1].Validator = (this: void, ...args: any) => { let result = validator_134539874(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.钩锁.LaunchMissileDash_1")) {
			data.Speed = (this: void, ...args: any) => { let result = validator_222950169(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.闪电链.CustomAction_1")) {
			data.Func = (this: void, ...args: any) => { let result = validator_228903203(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.闪电链.CustomAction_2")) {
			data.Func = (this: void, ...args: any) => { let result = validator_2540000(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.闪电链.Damage_1")) {
			data.Amount = (this: void, ...args: any) => { let result = validator_45382866(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.闪电链.Search_2")) {
			data.SearchValidators = (this: void, ...args: any) => { let result = validator_205128689(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.默认目标交互.CustomAction")) {
			data.Func = (this: void, ...args: any) => { let result = validator_253897080(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.默认骑乘交互.CustomAction")) {
			data.Validators = (this: void, ...args: any) => { let result = validator_219325151(...args); return result; }
			data.Func = (this: void, ...args: any) => { let result = validator_3959591(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.spell.默认骑乘结束.CustomAction")) {
			data.Validators = (this: void, ...args: any) => { let result = validator_142918539(...args); return result; }
			data.Func = (this: void, ...args: any) => { let result = validator_219120192(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.unit.火龙.MoverFunction")) {
			data.FunctionServer = (this: void, ...args: any) => { let result = validator_36377917(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.unit.狼人.ResponseEffectImpact")) {
			data.Validator = (this: void, ...args: any) => { let result = validator_175936324(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.unit.秃鹫.ResponseEffectImpact")) {
			data.Validator = (this: void, ...args: any) => { let result = validator_45075472(...args); return result; }
		}
		...
		if (data = base.eff.cache("$$default_units_ts.unit.防御塔-光环塔_1.Buff_2")) {
			data.KeyValuePairs[1].Value = (this: void, ...args: any) => { let result = validator_16625413(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.unit.防御塔-单体减速塔_1.Buff_1")) {
			data.KeyValuePairs[1].Value = (this: void, ...args: any) => { let result = validator_182754740(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.unit.防御塔-单体减速塔_1.EffectDamage")) {
			data.Amount = (this: void, ...args: any) => { let result = validator_187962312(...args); return result; }
		}
		if (data = base.eff.cache("$$default_units_ts.unit.防御塔-向量穿透塔_1.Damage_1")) {
			data.Amount = (this: void, ...args: any) => { let result = validator_119924838(...args); return result; }
		}
	}
	init_validator_0()
	init_validator_1()
