...
技能摇杆快捷键配置<node-value node="$$lib_control.shortcut_config.技能摇杆快捷键配置.root" field="Game.Keys"/>
显示技能描述所需长按时间<node-value node="$$lib_control.link_node.显示技能描述所需长按时间.root" field="Game.Value"/>]],
