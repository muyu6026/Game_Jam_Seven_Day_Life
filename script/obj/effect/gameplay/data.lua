...
entry_datas['default_units_ts_CureRule_1'] = {
    ...
    ['TextTagCrit'] = '$$spark_core.riseletter.回血.root',
    ['TextTag'] = '$$spark_core.riseletter.回血.root',
...
entry_datas['default_units_ts_DamageRule_3'] = {
    ...
    ['TextTagCrit'] = '$$spark_core.riseletter.法术暴击.root',
    ['TextTag'] = '$$spark_core.riseletter.法术伤害.root',
    ['TextTagSync'] = 'self|sight',
...
entry_datas['default_units_ts_DamageRule_4'] = {
    ...
    ['TextTagCrit'] = '$$spark_core.riseletter.物理暴击.root',
    ['TextTag'] = '$$spark_core.riseletter.物理伤害.root',
    ['TextTagSync'] = 'self|sight',
...
entry_datas['default_units_ts_DamageRule_5'] = {
    ...
    ['TextTagCrit'] = '',
    ['TextTag'] = '$$spark_core.riseletter.真实伤害.root',
    ['TextTagSync'] = 'self|sight',
...
entry_datas['root'] = {
    ...
    ['PCRightButtonActor'] = '',
    ['UpdateJoystickMoveDirectionOnCameraMove'] = false,
    ['ID'] = 'root',
    ['Class'] = 'gameplay',
    ['NodeType'] = 'Gameplay',
