...
entry_datas['StopOrder'] = {
    ...
    ['StopOrderFlags'] = {
        ...
        ['StopSpell'] = true,
        ['Stop'] = true,
        ['ClearQueuedOrders'] = true,
    },
    ['ID'] = 'StopOrder',
    ['Class'] = 'effect',
    ['NodeType'] = 'EffectStopOrder',
    ['NodeTypeLink'] = '$$.effect.EffectStopOrder',
    ['Template'] = 'EffectStopOrder',
    ['Link'] = '$$default_units_ts.buff.眩晕.StopOrder',
    ['event'] = event_register,
}
...
entry_datas['root'] = {
    ...
    ['InitialEffect'] = '$$default_units_ts.buff.眩晕.StopOrder',
    ['ExpireEffect'] = '',
    ['FinalEffect'] = '',
    ['PeriodicEffect'] = '',
    ['Period'] = (function ()
