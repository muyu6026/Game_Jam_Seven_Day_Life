return function (datas)
    local dict = {
        ...
        ['$$lib_control.link_node.显示技能描述所需长按时间.root'] = datas.link_node['$$lib_control.link_node.显示技能描述所需长按时间']['root'],
        ...
        ['$$smallcard_get_items.link_node.资源稀有度.LinkNodeString_3'] = datas.link_node['$$smallcard_get_items.link_node.资源稀有度']['LinkNodeString_3'],
        ['$$smallcard_get_items.link_node.资源稀有度.LinkNodeString_4'] = datas.link_node['$$smallcard_get_items.link_node.资源稀有度']['LinkNodeString_4'],
