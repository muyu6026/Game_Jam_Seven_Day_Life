...
entry_datas['Buff_1'] = {
    ...
    ['Sorts'] = {
        [1] = '$$spark_core.func_ref.优先高等级的Buff.root',
        [2] = '$$spark_core.func_ref.优先来自英雄的Buff.root',
        [3] = '$$spark_core.func_ref.优先剩余时间长的Buff.root',
    },
    ['InstanceMax'] = 0,
    ['StackMax'] = (function ()
        local func = function (EffectParam)
...
entry_datas['UnitItem_1'] = {
    ...
    ['DefaultAI'] = '$$spark_core.ai.testai.root',
    ['follow_random'] = 5,
    ['distance_random'] = {
        [1] = 125,
        [2] = 175,
    ...
    ['BloodStripProfile'] = {
        ...
        ['DefaultTemplate'] = '$$spark_core.bloodstrip.ALLY_NORMAL_NONE.root',
        ['SpecialTemplates'] = {
            ['Ally'] = '$$spark_core.bloodstrip.ALLY_NORMAL_NONE.root',
            ['Controlled'] = '$$spark_core.bloodstrip.ALLY_NORMAL_NONE.root',
            ['Enemy'] = '$$spark_core.bloodstrip.ENEMY_NORMAL_NONE.root',
            ['Neutral'] = '$$spark_core.bloodstrip.NEUTRAL_NORMAL_NONE.root',
        },
    },
    ...
    ['OccludingCameraEnable'] = false,
    ['PostSight'] = false,
    ['Character'] = '',
    ['Behaviors'] = '',
    ['StopMoveWhenChangeHero'] = true,
    ['RotationUpperBodyCastAllow'] = false,
    ['AllowRide'] = false,
    ['ID'] = 'UnitItem_1',
    ['Class'] = 'unit',
    ['NodeType'] = 'Unit',
...
entry_datas['SpellRootInstant_1'] = {
    ...
    ['SpellControlConfig'] = {
        ...
        ['DisplayDescriptionOnLongClick'] = false,
        ['DisplayDescriptionClickTimeNeeded'] = -1,
        ['DisplayDescriptionStopCast'] = true,
        ['DisplayCostOnDescription'] = true,
        ['DisplayCooldownOnDescription'] = true,
    ...
    ['RightButtonSkillConfig'] = {
        ...
        ['TargetUnitFilter'] = nil,
        ['Priority'] = 0,
        ['Actors'] = '',
    },
    ['DisableWhenDead'] = true,
    ['RotationUpperBodyAllow'] = false,
    ['RotationUpperBodyEnable'] = true,
...
entry_datas['LaunchMissile'] = {
    ...
    ['temp_impact_model'] = '',
    ['ImpactEffect'] = '',
    ['FinalEffect'] = '$$default_units_ts.item.金币神符_1.UnitRemove',
    ['FinishEffect'] = '$$default_units_ts.item.金币神符_1.PlayerModifyAttribute',
    ['ImpactMaxCount'] = (function ()
        local func = function (EffectParam)
            return -1
        end
    ...
    ['NodeTypeLink'] = '$$.effect.EffectLaunchMissile',
    ['Template'] = 'EffectLaunchMissile',
    ['Link'] = '$$default_units_ts.item.金币神符_1.LaunchMissile',
    ['event'] = event_register,
}
...
entry_datas['PlayerModifyAttribute'] = {
    ...
    ['NodeTypeLink'] = '$$.effect.EffectPlayerModifyAttribute',
    ['Template'] = 'EffectPlayerModifyAttribute',
    ['Link'] = '$$default_units_ts.item.金币神符_1.PlayerModifyAttribute',
    ['event'] = event_register,
}
...
entry_datas['Set_1'] = {
    ...
    ['TargetType'] = 'Any',
    ['EffectArray'] = {
        [1] = '$$default_units_ts.item.金币神符_1.LaunchMissile',
    },
    ['SetFlags'] = {
        ['Unordered'] = false,
        ['WithReplacement'] = false,
    ...
    ['NodeTypeLink'] = '$$.effect.EffectSet',
    ['Template'] = 'EffectSet',
    ['Link'] = '$$default_units_ts.item.金币神符_1.Set_1',
    ['event'] = event_register,
}
...
entry_datas['UnitRemove'] = {
    ...
    ['CanBeBlocked'] = true,
    ['TargetLocation'] = {
        ['Effect'] = '$$default_units_ts.item.金币神符_1.Set_1',
        ['Value'] = 'Target',
        ['LocalVar'] = 'A',
    },
    ['TargetType'] = 'Unit',
    ...
    ['NodeTypeLink'] = '$$.effect.EffectUnitRemove',
    ['Template'] = 'EffectUnitRemove',
    ['Link'] = '$$default_units_ts.item.金币神符_1.UnitRemove',
    ['event'] = event_register,
}

entry_datas['Unit_1'] = {
    ['Name'] = '[EntryNode][$$default_units_ts.item.金币神符_1.Unit_1].Data.Game.Name',
    ['Description'] = '[EntryNode][$$default_units_ts.item.金币神符_1.Unit_1].Data.Game.Description',
    ['Attribute'] = {
    },
    ['AttributeString'] = {},
    ['ModelScaleFactor'] = 1,
    ...
    ['ModelData'] = '$$default_units_ts.item.金币神符_1.Model',
    ['Loot'] = '',
    ['DeathTime'] = 0,
    ['LevelProfile'] = '',
    ['Inventorys'] = {
    ...
    ['NodeTypeLink'] = '$$.unit.Unit',
    ['Template'] = 'Unit',
    ['Link'] = '$$default_units_ts.item.金币神符_1.Unit_1',
    ['event'] = event_register,
}

entry_datas['root'] = {
    ['Name'] = '[EntryNode][$$default_units_ts.item.金币神符_1.root].Data.Game.Name',
    ['Icon'] = '',
    ['Unit'] = '$$default_units_ts.item.金币神符_1.Unit_1',
    ['Description'] = '[EntryNode][$$default_units_ts.item.金币神符_1.root].Data.Game.Description',
    ['ItemTooltipOption'] = {
        ['ShowQuality'] = true,
        ['ShowName'] = true,
        ['ShowExtraModsOnTitle'] = false,
    ...
    ['NodeTypeLink'] = '$$.item.ItemPowerUp',
    ['Template'] = 'ItemPowerUp',
    ['Link'] = '$$default_units_ts.item.金币神符_1.root',
    ['event'] = event_register,
}
module_datas['$$default_units_ts.item.金币神符_1'] = entry_datas
return module_datas